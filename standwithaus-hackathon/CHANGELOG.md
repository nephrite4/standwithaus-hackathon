...
- refactor(Dashboard2): tweak lazy and Suspense for Widget03 
...
- feat(Dashboard2): new `Suspense` example with Widget03
...
- refactor: Dashboard2 legend badge pill
...
###### `v1.0.8`
- refactor: Dashboard2 radio buttons, new `onRadioBtnClick()` method
...
- Dashboard2 .dropdown-menu-right temp.scss hotfix (full)
- callout.scss .chart-wrapper hotfix (full)

###### `2017.08.11`
- Bootstrap 4 beta
- Dashboard2 component (full):
